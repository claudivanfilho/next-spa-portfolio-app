export const GENERATION_REPONSE_MOCK = {
  abilities: [],
  id: 1,
  ...
  names: [
    ...
    { language: { name: "ko", url: "https://pokeapi.co/api/v2/language/3/" }, name: "1세대" },
    {
    ...
    { language: { name: "ja", url: "https://pokeapi.co/api/v2/language/11/" }, name: "第一世代" },
  ],
  pokemon_species: [
